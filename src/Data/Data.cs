...
public static class Scenes
{
    public static Dictionary<(AreaKind, AreaKind), (Vector3, Direction)> Transitions = new Dictionary<(AreaKind, AreaKind), (Vector3, Direction)>()
    {
        ...
        {(AreaKind.Sewer, AreaKind.Cellar), (new Vector3(0, 0, 2), Direction.East)},
        {(AreaKind.Sewer, AreaKind.Woods), (new Vector3(10, 0, 3), Direction.South)},
        {(AreaKind.Cellar, AreaKind.Sewer), (new Vector3(2, 0, 12), Direction.North)},
        ...
        {(AreaKind.ManorGrounds, AreaKind.ManorHouse), (new Vector3(5, 0, 8), Direction.West)},
